...
We successfully generated *K*<sub>D</sub> estimates for `r sum(!is.na(dt[library=="lib51_53A",Kd_hDPP4]))` of our lib51_53A barcodes (`r round(sum(!is.na(dt[library=="lib51_53A",Kd_hDPP4]))/nrow(dt[library=="lib51_53A",])*100,digits=2)`%), and `r sum(!is.na(dt[library=="lib52_54A",Kd_hDPP4]))` of our lib52_54A barcodes (`r round(sum(!is.na(dt[library=="lib52_54A",Kd_hDPP4]))/nrow(dt[library=="lib52_54A",])*100,digits=2)`%). 
...
```{r binding_distribution_vioplot, echo=T, fig.width=6, fig.height=9, fig.align="center", dpi=300,dev="png"}
