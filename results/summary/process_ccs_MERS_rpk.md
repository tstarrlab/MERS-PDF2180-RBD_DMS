...
```
    ...
    Saving plot to results/process_ccs/amplicons_MERS_rpk.pdf
...
![png](process_ccs_MERS_rpk_files/process_ccs_MERS_rpk_89_1.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_MERS_rpk.pdf
